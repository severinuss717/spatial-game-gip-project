...
#Button actions
def start_game():
    subprocess.Popen([sys.executable, "level_1.py"])  # Ensure "main.py" exists
...
#Header text
header_text = ("Welcome to level 1! of spatial gaming, You are required to interact with all icons! "
               "Clearly read all the information that will be provided by the icons " 
               "As it is required to complete the quiz " 
               "At the end "
               "Start loking for eath like icon as your first interaction "
               "GOOD LUCK!!.")
